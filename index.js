...
console.log(uri);
// const uri = "mongodb+srv://<username>:<password>@cluster0.grqmol8.mongodb.net/?retryWrites=true&w=majority";
...
async function run() {
  try {
    ...
    // receive data from client side and update to database:-
